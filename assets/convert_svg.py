...
create_colored_png("assets/svg/refresh.svg", "assets/icons/refresh_dark.png", "#E0E0E0") # light gray for dark mode
create_colored_png("assets/svg/refresh.svg", "assets/icons/refresh_light.png", "#202020") # dark gray for light mode
