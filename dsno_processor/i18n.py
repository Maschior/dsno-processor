...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "dl.description_column": "Description Column:",
        ...
        "settings.processor.keep_original": "Retain original DSNO files:",
        "settings.processor.keep_original_hint": "If enabled, the original DSNO file is preserved and moved to the 'processed/original_files' directory.",
        # ── Settings: EBS ───────────────────────────────────────
        ...
        "settings.columns.description_hint": "Name of the description (Obs) column.",
        ...
        "msg.download_complete": "Download complete: {success} new file(s) downloaded, {skipped} already existing (ignored).",
        ...
        "import.success": "Import complete: {imported} new record(s) added, {skipped} already existing (ignored).",
        ...
        "import_control.success": "Import complete: {imported} new record(s) added, {updated} updated, {skipped} skipped.",
        ...
        # ── Sync status ───────────────────────────────────────────────
        "sync_status.btn_label": "Sync Spreadsheet Status",
    ...
    "pt": {
        ...
        "dl.description_column": "Coluna Obs (Description):",
        ...
        "settings.processor.keep_original": "Manter arquivos DSNO originais:",
        "settings.processor.keep_original_hint": "Se ativado, o arquivo DSNO original é preservado e movido para a pasta 'processed/original_files'.",
        # ── Settings: EBS ───────────────────────────────────────
        ...
        "settings.columns.description_hint": "Nome da coluna de descrição (Obs).",
        ...
        "msg.processing_errors": "{summary}\n{failed} erro(s).",
        "msg.download_complete": "Download concluído: {success} novo(s) arquivo(s) baixado(s), {skipped} já existente(s) (ignorados).",
        ...
        "import.success": "Importação concluída: {imported} novo(s) registro(s) adicionado(s), {skipped} já existente(s) (ignorados).",
        ...
        "import_control.success": "Importação concluída: {imported} novo(s) registro(s) adicionado(s), {updated} atualizado(s), {skipped} ignorado(s).",
        ...
        # ── Sync status ───────────────────────────────────────────────
        "sync_status.btn_label": "Sincronizar Status da Planilha",
        "sync_status.title": "Sincronizar Status",
